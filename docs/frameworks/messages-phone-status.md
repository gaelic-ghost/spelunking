...
| Agents and services | LaunchAgents, XPC services, app extensions, plugin edges, and runtime activation edges documented | LaunchAgents, XPC/extension services, entitlement-backed service edges, and runtime activation edges documented | [Messages agents](Messages/agents.md), [Phone agents](Phone/agents.md) |
...
- Map private XPC protocol families to concrete mach services and likely client processes from launchd, entitlement, and runtime evidence.
